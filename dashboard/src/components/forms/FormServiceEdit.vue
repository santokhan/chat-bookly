  ...
  <form @submit.prevent="onCreateService">
    ...
    <div class="flex items-center px-5 py-4 gap-3.5">
      ...
      <div class="grow flex items-start">
        <div class="grow">
          <h2 class="text-sm font-medium text-strong">Edit Service</h2>
          <p class="mt-1 text-xs text-secondary">Manage & edit service</p>
        </div>
    ...
    <div class="border-t border-border-light p-5 space-y-3">
      ...
      <div>
        ...
        <input v-model="form.name" type="text" required placeholder="Add a service name e:g: Mens Haircut"
          class="w-full border border-border-light rounded-[0.625rem] px-3 py-2.5 text-sm" />
      </div>

      <!-- Description -->
      <div>
        <label class="block text-sm font-medium text-strong mb-1">Description (optional)</label>
      ...
      <div class="">
        <div>
          ...
          <div class="flex items-center gap-2 w-full border border-border-light rounded-[0.625rem] px-3 py-2.5 text-sm">
            ...
            <select v-model="form.category_id" class="w-full focus:outline-none disabled:text-neutral-200" disabled>
