  ...
  <Modal v-model="modal">
    <div>
      <div class="flex flex-col items-center p-5 fade-in" data-aos="zoom-in" data-aos-duration="500">
        ...
        <h2 class="font-medium text-center mt-4 text-strong">Delete Service Permamently</h2>
        <p class="text-center mt-2 text-secondary">Are you sure you want to Delete this service? Your service will be deleted from your listing.</p>
      </div>
      <div class="border-t border-border-light flex gap-3 px-5 py-4">
        <ButtonOutlineGray type="button" @click="modal = false" class="w-full justify-center">
          Close
        </ButtonOutlineGray>
