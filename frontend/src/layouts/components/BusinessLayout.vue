...
<template>
  <div class="layout-wrapper" :class="[configStore._layoutClasses, { 'layout-overlay-nav': isOverlayNavActive }]">
    <!-- Full Width Header -->
    <header class="layout-header">
      <div class="header-content">
        <!-- Mobile menu toggle -->
        <IconBtn id="vertical-nav-toggle-btn" class="d-lg-none me-3" @click="toggleIsOverlayNavActive(true)">
        ...
        <div class="header-action pt-1">
          <Component :is="themeConfig.app.iconRenderer || 'div'" v-show="configStore.isVerticalNavCollapsed"
    ...
    <div class="layout-content">
      ...
      <div class="nav-drawer-wrapper">
        <VerticalNav :is-overlay-nav-active="isOverlayNavActive"
          :toggle-is-overlay-nav-active="toggleIsOverlayNavActive" :nav-items="navItems" class="nav-drawer">
    ...
    <!-- Mobile Overlay -->
    <div class="mobile-overlay" :class="{ 'overlay-visible': isLayoutOverlayVisible }"
